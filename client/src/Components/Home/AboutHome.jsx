                ...
                <div class="flex flex-wrap -m-4">
                  <div class="p-4 lg:w-1/3">
                    <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                      <h2 class="tracking-widest text-xl title-font font-xl text-gray-400 mb-1">
                        Tutorials
                      </h2>
                      <br />
                      <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">
                        With our tutorials, we provide limitless possibilities
                        to learn C++.
                      </h1>
                      <br />
                      <br /> <br />
                  ...
                  <div class="p-4 lg:w-1/3">
                    <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                      ...
                      <br />
                      <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">
                        Put your knowledge to the test and solidify your
                  ...
                  <div class="p-4 lg:w-1/3">
                    <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                      ...
                      <br />
                      <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">
                        Unleash your imagination, learn cutting-edge techniques,
                        and leave your mark on the digital landscape with our
                        diverse range of inspiring coding projects.
                      </h1>
