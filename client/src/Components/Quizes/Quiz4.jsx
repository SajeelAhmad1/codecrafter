  ...
  const questions = [
    {
      id: 1,
      question:
        "  Operator used to print on screen is:",
      options: [
        "insertion operator ( << )",
        "extraction operator ( << )",
        "insertion operator ( >> )",
    ...
    {
        id: 2,
        question: "  To print new line we use",
        options: [
          "\n inside double quotes",
          "endl inside double quotes",
          "endl outside double quotes",
          "Both A and C",
        ],
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter4">
