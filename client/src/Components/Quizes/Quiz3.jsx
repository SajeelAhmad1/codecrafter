...
const Quiz3 = () => {
  ...
  const questions = [
    ...
    {
      id: 2,
      question: 'To print "Hi there!", we write:',
      options: ['console.log ( "Hi there!" )', 'print ( "Hi there!" )', 'cout << "Hi there!";', 'printing ( "Hi there!" )'],
      correctAnswer: 'cout << "Hi there!";',
    },
    {
      id: 3,
      question: "Last line of execution in main program is:",
      options: ["end;", "stop;", "break;", "return 0;"],
      correctAnswer: "return 0;",
    },
    {
      id: 4,
      question: "Execution starts from:",
      options: ["main function", "int main()", "Both A and B", "#include<iostream>"],
      correctAnswer: "Both A and B",
    },
    {
      id: 5,
      question: "C++ compiler ignores white spaces.",
      options: ["Yes", "No"],
      correctAnswer: "Yes",
    },
    {
        ...
        <div class="container">
          <div className="ch-content">
            ...
            <div class="main-body ui segment">
              ...
              <span class="tut-btn"><Link to="/tutorials/Chapter3">
